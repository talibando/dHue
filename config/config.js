module.exports = {
	...
	ownerID: ['xxxxxxxxxxxxxxxxxx', 'yyyyyyyyyyyyyyyyyy'],	//If ownerOnly is toggled, this is the Discord user ID of the user you want to be able to do all of the commands. This supports multiple ownerIDs
